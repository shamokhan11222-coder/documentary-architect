...
export const Route = createFileRoute("/docs")({
  head: () => ({
    meta: [
      { title: "Docs — Stickmax Studio" },
      { name: "description", content: "Guides, tutorials, and API references for Stickmax Studio." },
      { property: "og:title", content: "Docs — Stickmax Studio" },
      { property: "og:description", content: "Guides, tutorials, and API references for Stickmax Studio." },
    ],
  }),
  component: DocsPage,
});
    ...
    <div className="brand-gradient min-h-screen">
      <div className="mx-auto max-w-4xl px-6 py-20 text-center">
        ...
        <p className="mx-auto mt-5 max-w-xl text-lg text-muted-foreground">
          Guides, tutorials, and API references for Stickmax Studio.
        </p>
