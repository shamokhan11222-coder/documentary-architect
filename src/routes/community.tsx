...
export const Route = createFileRoute("/community")({
  head: () => ({
    meta: [
      { title: "Community — Stickmax Studio" },
      { name: "description", content: "Join thousands of creators building AI documentaries with Stickmax Studio." },
      { property: "og:title", content: "Community — Stickmax Studio" },
      { property: "og:description", content: "Join thousands of creators building AI documentaries with Stickmax Studio." },
    ],
  }),
    ...
    <div className="brand-gradient min-h-screen">
      <div className="mx-auto max-w-4xl px-6 py-20 text-center">
        ...
        <p className="mx-auto mt-5 max-w-xl text-lg text-muted-foreground">
          Join thousands of creators building AI documentaries with Stickmax Studio.
        </p>
